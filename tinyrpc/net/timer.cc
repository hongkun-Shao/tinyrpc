...
void Timer::AddTimerEvent(TimerEvent::s_ptr event){
    ...
    DEBUGLOG("success add TimerEvent whose arrive time %lld ms", event->get_arrive_time());
}
...
void Timer::DeleteTimerEvent(TimerEvent::s_ptr event){
    ...
    lock.unlock();
    DEBUGLOG("success delete TimerEvent whose arrive time %lld ms", event->get_arrive_time());
}
