...
extern makeOrderResponseDefaultTypeInternal
    _makeOrderResponse_default_instance_;
PROTOBUF_NAMESPACE_OPEN
template <>
::makeOrderRequest* Arena::CreateMaybeMessage<::makeOrderRequest>(Arena*);
template <>
::makeOrderResponse* Arena::CreateMaybeMessage<::makeOrderResponse>(Arena*);
PROTOBUF_NAMESPACE_CLOSE

// ===================================================================

class makeOrderRequest final : public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:makeOrderRequest)
                                                                        */
{
 public:
  inline makeOrderRequest() : makeOrderRequest(nullptr) {}
  ~makeOrderRequest() override;
  explicit constexpr makeOrderRequest(
      ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  makeOrderRequest(const makeOrderRequest& from);
  makeOrderRequest(makeOrderRequest&& from) noexcept : makeOrderRequest() {
    *this = ::std::move(from);
  }
...
class makeOrderResponse final : public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:makeOrderResponse)
                                                                         */
{
 public:
  inline makeOrderResponse() : makeOrderResponse(nullptr) {}
  ~makeOrderResponse() override;
  explicit constexpr makeOrderResponse(
      ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  makeOrderResponse(const makeOrderResponse& from);
  makeOrderResponse(makeOrderResponse&& from) noexcept : makeOrderResponse() {
    *this = ::std::move(from);
  }
...
// int32 price = 1;
inline void makeOrderRequest::clear_price() { price_ = 0; }
inline int32_t makeOrderRequest::_internal_price() const { return price_; }
...
// string goods = 2;
inline void makeOrderRequest::clear_goods() { goods_.ClearToEmpty(); }
...
inline PROTOBUF_ALWAYS_INLINE void makeOrderRequest::set_goods(ArgT0&& arg0,
                                                               ArgT... args) {
  goods_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{},
...
inline void makeOrderRequest::set_allocated_goods(std::string* goods) {
  ...
  goods_.SetAllocated(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), goods,
      GetArenaForAllocation());
...
// int32 ret_code = 1;
inline void makeOrderResponse::clear_ret_code() { ret_code_ = 0; }
...
// string res_info = 2;
inline void makeOrderResponse::clear_res_info() { res_info_.ClearToEmpty(); }
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE void makeOrderResponse::set_res_info(
...
inline void makeOrderResponse::_internal_set_res_info(
    const std::string& value) {
  res_info_.Set(
...
inline void makeOrderResponse::set_allocated_res_info(std::string* res_info) {
  ...
  res_info_.SetAllocated(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      res_info, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
// string order_id = 3;
inline void makeOrderResponse::clear_order_id() { order_id_.ClearToEmpty(); }
inline const std::string& makeOrderResponse::order_id() const {
  // @@protoc_insertion_point(field_get:makeOrderResponse.order_id)
  return _internal_order_id();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE void makeOrderResponse::set_order_id(
    ArgT0&& arg0, ArgT... args) {
  order_id_.Set(
      ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{},
      static_cast<ArgT0&&>(arg0), args..., GetArenaForAllocation());
...
inline void makeOrderResponse::_internal_set_order_id(
    const std::string& value) {
  order_id_.Set(
      ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value,
      GetArenaForAllocation());
...
inline void makeOrderResponse::set_allocated_order_id(std::string* order_id) {
  ...
  order_id_.SetAllocated(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      order_id, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
