...
void test_io_thread(){
    ...
    tinyrpc::IOThreadPool io_thread_pool(2);
    tinyrpc::IOThread * io_thread = io_thread_pool.get_iothread();
    io_thread->get_eventloop()->AddEpollEvent(&event);
    io_thread->get_eventloop()->AddTimerEvent(timer_event);

    tinyrpc::IOThread * io_thread2 = io_thread_pool.get_iothread();
    io_thread2->get_eventloop()->AddTimerEvent(timer_event);
