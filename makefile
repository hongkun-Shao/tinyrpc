...
# PATH_ZOOKEEPER = /usr/include/zookeeper
CXX := g++
...
LIBS += /usr/lib/libprotobuf.a	/usr/lib/libtinyxml.a /usr/lib/libzookeeper_mt.a
...
# install
install:
	mkdir -p $(PATH_INSTALL_INC_TOOL) $(PATH_INSTALL_INC_NET) $(PATH_INSTALL_INC_TCP) $(PATH_INSTALL_INC_CODER) $(PATH_INSTALL_INC_RPC)\
